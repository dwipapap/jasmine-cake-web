...
export function CategorySection({ categories }: CategorySectionProps) {
  ...
  return (
    <section className="relative py-24 md:py-32 overflow-hidden bg-cream-50/50">
      ...
      <div className="absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-burgundy-100/30 rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-0 right-0 translate-x-1/3 translate-y-1/3 w-[700px] h-[700px] bg-gold/10 rounded-full blur-[100px] pointer-events-none" />
